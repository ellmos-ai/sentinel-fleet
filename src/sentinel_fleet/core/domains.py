    ...
    def _seed_default_domains(self):
        seeds = [
            EnterpriseDomain(
                ...
                code="FIN-TAX",
                icon="⚡",
                description="Autonomous invoice processing, § 14 UStG compliance audit, GoBD ledger and vendor dispute loop.",
                is_active=True,
            ...
            EnterpriseDomain(
                ...
                code="LEGAL-SENTRY",
                icon="⚖️",
                description="Automated checks for GDPR PII masking, liability disclaimers and audit-proof retention.",
                is_active=True,
            ...
            EnterpriseDomain(
                ...
                code="VENDOR-OPS",
                icon="🤝",
                description="Automated clarification workflows, vendor master data synchronisation and SLA monitoring.",
                is_active=True,
